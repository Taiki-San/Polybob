...
Catalog::Catalog()
{
	...
	functionCodes = {FCODE_EXPAND, FCODE_FACTOR, FCODE_EVALUATE, FCODE_INTERPOLATE, FCODE_COMPOSITION, FCODE_DIVISION, FCODE_DEGREE, FCODE_DERIVATIVE, FCODE_INTEGRAL, FCODE_GCD, FCODE_EXTRACTION, FCODE_CONJUGAISON};
	functionNames = {"expand", "factor", "evaluate", "interpolate", "composition", "division", "degree", "derivative", "integral", "gcd", "complexExtraction", "conjugate"};
	functionArgumentNumber = {1, 1, 2, 0, 2, 2, 1, 1, 1, 2, 1, 1};
	functionArgumentType = {{FARG_TYPE_FACTORISED}, {FARG_TYPE_POLY_NOFACT}, {FARG_TYPE_POLY, FARG_TYPE_NUMBER}, {FARG_TYPE_REAL}, {FARG_TYPE_POLY, FARG_TYPE_POLY}, {FARG_TYPE_ANY, FARG_TYPE_ANY}, {FARG_TYPE_POLY}, {FARG_TYPE_POLY}, {FARG_TYPE_POLY}, {FARG_TYPE_POLY, FARG_TYPE_POLY}, {FARG_TYPE_POLY}, {FARG_TYPE_POLY}};
	functionReturnType = {FARG_TYPE_POLY_NOFACT, FARG_TYPE_FACTORISED, FARG_TYPE_NUMBER, FARG_TYPE_POLY, FARG_TYPE_POLY_NOFACT, FARG_TYPE_DIV_RESULT, FARG_TYPE_REAL, FARG_TYPE_POLY_NOFACT, FARG_TYPE_POLY_NOFACT, FARG_TYPE_POLY_NOFACT, FARG_TYPE_EXT_RESULT, FARG_TYPE_POLY};
}
